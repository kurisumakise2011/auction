...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .csrf().disable()
                .authorizeRequests()
                .antMatchers(HttpMethod.POST, "/filter/items/**")
                .permitAll()
                .and()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/dictionary/**")
                .permitAll()
                .and()
                .authorizeRequests()
                .antMatchers("/", "/main", "/resources/**", "/users/who", "/users/**", "/profile/**")
                .permitAll()
                .and()
                .authorizeRequests()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/dictionary/**", "/admin/**", "/admin")
                .hasAuthority("ADMIN")
                .and()
                .authorizeRequests()
                .anyRequest()
